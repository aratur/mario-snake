...
import { changeDirection, getLevel, getWasKilled } from './store/snakeSlice';
...
function App() {
  ...
  }, [dispatch, stop, wasKilled, isRunning, componentDidMount]);

  const dispatchChangeDirection = (direction: string) =>
  ...
  return (
    <div className="w3-container">
      ...
      <div className="w3-cell-row">
        <div className="w3-cell w3-margin-top w3-center w3-mobile w3-hide-small w3-cell-middle"></div>
        ...
        <div className="w3-cell w3-margin-top w3-center w3-mobile w3-cell-middle">
          <Navigation start={dispatchStart} stop={stop} isRunning={isRunning} />
        </div>
      </div>
    </div>
  );
